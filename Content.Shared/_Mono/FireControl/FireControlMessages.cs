...
public struct FireControllableEntry
{
    ...
    /// <summary>
    /// Whether this weapon requires manual reloading
    /// </summary>
    public bool HasManualReload;

    /// <summary>
    /// Current ammo count (null if not manually reloaded)
    /// </summary>
    public int? AmmoCount;

    public FireControllableEntry(NetEntity entity, NetCoordinates coordinates, string name, bool hasManualReload = false, int? ammoCount = null)
    {
        NetEntity = entity;
        Coordinates = coordinates;
        Name = name;
