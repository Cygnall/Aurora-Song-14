// Taken from NanotrasenNameGenerator.cs, but altered to use the SLE prefixes and suffixes instead of NT ones.
...
[UsedImplicitly]
public sealed partial class SleNameGenerator : StationNameGenerator
{
    /// <summary>
    ...
    private string Prefix => "AS"; // Aurora Sector
    private string[] SuffixCodes => new []{ "SLE" }; // Sector Law Enforcement
